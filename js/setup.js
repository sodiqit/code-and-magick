...
// create drag n drop - start
var userPic = document.querySelector('.upload > input');
...
userPic.addEventListener('mousedown', function (evt) {
  ...
  var onMouseUp = function (upEvt) {
    ...
    if (dragged) {
      var onUserClick = function (dragEvt) {
        dragEvt.preventDefault();
        userPic.removeEventListener('click', onUserClick);
      };

      userPic.addEventListener('click', onUserClick);
    }
